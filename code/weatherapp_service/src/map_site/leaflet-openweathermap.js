 ...
 */
 ...
 L.OWM = L.TileLayer.extend({
	options: {
		appId: '664db12c121ec6f39b98db6040a42f2c', /* pass your own AppId as parameter when creating the layer. Get your own AppId at https://www.openweathermap.org/appid */
...
L.OWM.Current = L.Layer.extend({
	...
	options: {
		appId: '664db12c121ec6f39b98db6040a42f2c', // get your free Application ID at www.openweathermap.org
		...
		imageLoadingUrl: 'leaflet\\owmloading.gif', // URL of loading image relative to HTML document
	...
	initialize: function(options) {
		...
		this._map = null;
		this._urlTemplate = 'https://pro.openweathermap.org/data/2.5/box/{type}?{appId}cnt=300&format=json&units=metric&bbox={minlon},{minlat},{maxlon},{maxlat},10';
